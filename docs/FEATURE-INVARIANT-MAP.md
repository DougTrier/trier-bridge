...
**Generated from `VALIDATION.md` (the "Invariant impact" line of every evidence entry) by `tools/dev.py map`, 2026-09-21 05:41 PM CDT.** Regenerate whenever an entry is added; this file is derived, not edited by hand (ARC-13).
...
| DOC-02.01 | In-app file browser: read-only browsing, mutations, root curation | TB-INV-006, TB-INV-050, TB-INV-234, TB-INV-237, TB-INV-239, TB-INV-242, TB-INV-243, TB-INV-244 |
