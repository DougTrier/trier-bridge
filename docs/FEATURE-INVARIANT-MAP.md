...
**Generated from `VALIDATION.md` (the "Invariant impact" line of every evidence entry) by `tools/dev.py map`, 2026-09-21 01:17 PM CDT.** Regenerate whenever an entry is added; this file is derived, not edited by hand (ARC-13).
