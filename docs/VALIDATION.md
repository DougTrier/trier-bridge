...
- **Evidence state:** INTEGRATION_VERIFIED (terminal and operations) plus DESKTOP_VERIFIED (Disk Management page walked live) on Ubuntu 24.04.5; Files page walk still pending
