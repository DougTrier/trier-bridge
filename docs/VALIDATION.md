...
- **Evidence state:** INTEGRATION_VERIFIED (terminal and operations) plus DESKTOP_VERIFIED (Disk Management and Files pages both walked live) on Ubuntu 24.04.5
