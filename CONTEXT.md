...
**Owner:** Doug Trier  
**Project state:** FOUNDATION 05 IN PROGRESS  
...
1a. Foundation 05: preferences durability, operation journal with atomic records, crash/restart reconciliation, recovery retention, fault tests in the VM
